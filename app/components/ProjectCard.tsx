...
// Satu-satunya definisi kartu project — dipakai grid beranda dan
// halaman /projects. Ubah tampilan kartu di sini, bukan di pemakainya.
export default function ProjectCard({ project: p }: { project: Project }) {
  return (
    <article className="group flex flex-col overflow-hidden rounded-(--radius) border border-dashed border-border">
      <div className="p-2">
        {p.imageFit === "contain" ? (
